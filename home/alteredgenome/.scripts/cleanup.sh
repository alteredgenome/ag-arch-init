...
figlet aClean
echo "The Arch Linux Cleaner"
echo "v2.2 - AlteredGenome"
echo ""
echo Cleaning yay and pacman caches...
## Assuming yay is run by user with UID 1000
admin="$(id -nu 1000)"
cachedir="/home/alteredgenome/.cache/yay"
...
echo Clearing the Trash Archive...
